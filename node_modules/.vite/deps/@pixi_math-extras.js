...
// node_modules/@pixi/math-extras/lib/pointExtras.mjs
var mixins = {
  /**
   ...
   */
  add(other, outPoint) {
    return outPoint || (outPoint = new Point()), outPoint.x = this.x + other.x, outPoint.y = this.y + other.y, outPoint;
  },
  /**
  ...
  multiplyScalar(scalar, outPoint) {
    return outPoint || (outPoint = new Point()), outPoint.x = this.x * scalar, outPoint.y = this.y * scalar, outPoint;
  },
  /**
...
// node_modules/@pixi/math-extras/lib/rectangleExtras.mjs
...
Rectangle.prototype.equals = function(other) {
  return other === this ? true : other && this.x === other.x && this.y === other.y && this.width === other.width && this.height === other.height;
};
...
// node_modules/@pixi/math-extras/lib/index.mjs
