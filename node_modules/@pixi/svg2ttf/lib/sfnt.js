...
function Font() {
  ...
  Object.defineProperty(this, 'ySubscriptYSize', {
    get: function () {
      return parseInt(
        !_.isUndefined(this.int_ySubscriptYSize) ? this.int_ySubscriptYSize : (this.ascent - this.descent) * 0.7,
        10,
      );
    },
    set: function (value) {
  ...
  Object.defineProperty(this, 'ySubscriptYOffset', {
    get: function () {
      return parseInt(
        !_.isUndefined(this.int_ySubscriptYOffset) ? this.int_ySubscriptYOffset : (this.ascent - this.descent) * 0.14,
        10,
      );
    },
    set: function (value) {
  ...
  Object.defineProperty(this, 'ySuperscriptYSize', {
    get: function () {
      return parseInt(
        !_.isUndefined(this.int_ySuperscriptYSize) ? this.int_ySuperscriptYSize : (this.ascent - this.descent) * 0.7,
        10,
      );
    },
    set: function (value) {
  ...
  Object.defineProperty(this, 'yStrikeoutSize', {
    get: function () {
      return parseInt(
        !_.isUndefined(this.int_yStrikeoutSize) ? this.int_yStrikeoutSize : (this.ascent - this.descent) * 0.049,
        10,
      );
    },
    set: function (value) {
  ...
  Object.defineProperty(this, 'underlinePosition', {
    get: function () {
      return parseInt(
        !_.isUndefined(this.int_underlinePosition) ? this.int_underlinePosition : (this.ascent - this.descent) * 0.01,
        10,
      );
    },
    set: function (value) {
